 ...
 * This file demonstrates how to integrate Nodekey with a web frontend
 */

// For React/Vue/Angular applications
export class NodekeyClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NodekeyClient(provider, contractAddress);
